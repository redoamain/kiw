// File: app/(dashboard)/lbk/columns.tsx
"use client";
...
export const columns = (setSelectedRows?: (rows: LbkType[]) => void): ColumnDef<LbkType>[] => [
  {
    id: "select",
    header: ({ table }) => {
    ...
    cell: ({ row }) => {
      ...
      const rowWithTable = row as RowWithTable<LbkType>;
