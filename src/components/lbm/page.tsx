...
const DataLbmPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    toast.promise(myPromise, {
      loading: "Memuat data LBM...",
      success: "Data LBM berhasil dimuat!",
      error: "Gagal memuat data LBM",
    });
  }, [dispatch]);
  ...
  const handleExport = () => {
    ...
    const fileName = `Data_LBM_${searchTerm ? searchTerm : ''}_${new Date().toISOString().split('T')[0]}${EXCEL_EXTENSION}`;
  ...
  const handleDateRangeChange = (
    ...
    const myPromise = dispatch(fetchLbmData({ startDate, endDate }));
    toast.promise(myPromise, {
  ...
  // Statistik tambahan berdasarkan field yang mungkin ada di data LBM
    ...
    <div className="flex items-center justify-center min-h-screen">
      <Card className="w-full max-w-md">
        ...
        <CardContent className="space-y-4">
          <p className="text-muted-foreground">Terjadi kesalahan saat memuat data LBM:</p>
    ...
    <div className="container mx-auto py-6 space-y-6">
      ...
      <div className="flex flex-col gap-2">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-3xl font-bold tracking-tight">Data LBM</h1>
            <p className="text-muted-foreground">
              Kelola dan pantau seluruh data Laporan Barang Masuk (LBM)
            </p>
          </div>
        </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Semua laporan LBM</p>
          </CardContent>
        </Card>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Filter data LBM berdasarkan kriteria tertentu
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-2">
                ...
                <label className="text-sm font-medium">Pencarian Data LBM</label>
              </div>
              <div className="relative">
                <Search className="absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-muted-foreground" />
                <Input
                  type="search"
                  placeholder="Cari berdasarkan nomor LBM, supplier, atau nama barang..."
                  value={searchTerm}
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-between items-start sm:items-center">
            <div className="text-sm text-muted-foreground">
              {searchTerm 
                ? `Menampilkan ${filteredItems} dari ${totalItems} data LBM (setelah pencarian)`
                : `Menampilkan ${totalItems} data LBM`
              }
            </div>
      ...
      <Card>
        <CardHeader>
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              <CardTitle>Daftar Data LBM</CardTitle>
              <CardDescription>
          ...
          {data.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-12 text-center space-y-4">
              ...
              <div className="space-y-2">
                <h3 className="text-lg font-semibold">Tidak ada data LBM</h3>
                <p className="text-muted-foreground max-w-md">
                  Data LBM kosong. Coba refresh!!
                </p>
              </div>
